	 package com.example.malav.blindappliction;
...
public class Main extends Activity implements TextToSpeech.OnInitListener
    ...
    @Override protected void onCreate(Bundle savedInstanceState)
		...
		voice = (TextView) findViewById(R.id.browser);
	...
	@Override public void onResume()
		...
		GlobalVars.selectTextView(voice,false);
	...
	public void select()
		...
		switch (GlobalVars.activityItemLocation)
			...
			case 5: //Voice Recorder
			GlobalVars.selectTextView(voice,true);
			GlobalVars.selectTextView(music,false);
			GlobalVars.selectTextView(alarms,false);
